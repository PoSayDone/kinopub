...
import io.github.posaydone.filmix.core.model.kinopub.KinoPubAuthErrorResponse
...
class AuthRemoteDataSource @Inject constructor(
    ...
    private fun parseErrorMessage(rawError: String?): String? {
        return parseAuthError(rawError)?.error_description
            ?: parseAuthError(rawError)?.error
    }
}
